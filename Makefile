...
unit-tests: ## Run unit tests
	...
	source <(setup-envtest use -i -p env 1.19.2); \
...
proto: ## Generate protobuf files
	@go install github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-grpc-gateway@v2.7.1 \
	  github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-openapiv2@v2.7.1
