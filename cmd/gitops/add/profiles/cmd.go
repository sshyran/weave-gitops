...
func AddCommand(opts *config.Options) *cobra.Command {
	cmd := &cobra.Command{
		Use:           "profile",
...
func addProfileCmdRunE(opts *config.Options) func(*cobra.Command, []string) error {
